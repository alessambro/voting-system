...
CREATE TABLE `votes` (
  ...
  CONSTRAINT `votes_ibfk_1` FOREIGN KEY (`candidate_name`) REFERENCES `candidates` (`name`) ON DELETE CASCADE
...
INSERT INTO `votes` VALUES (61,'john'),(59,'lesandro'),(60,'lesandro');
